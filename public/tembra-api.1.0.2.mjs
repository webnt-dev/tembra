function t(t,...e){return t.reduce((t,a,i)=>`${t}${a}${i in e?e[i]:""}`,"")}function e(t,e){return{data:null,errors:[{message:"",locations:[],path:[]}],http:{status:e,statusText:t}}}async function a(t,a,i={},s){try{const r=await fetch(t,{method:"POST",headers:i,body:JSON.stringify({query:a.query,variables:a.variables})});if(200!==r.status)return e(r.statusText,r.status);const n=await r.json();return n.http={status:200,statusText:"OK"},Array.isArray(n.errors)||(n.errors=null),n.data||(n.data=null),s&&s(n),n}catch(t){const a=e("",0);return t instanceof Error&&(a.errors[0].message=t.name,"AbortError"===t.name&&(a.http.status=1)),a}}class i extends Error{data;constructor(t){super(t.extensions?.code??t.message),this.data=t.extensions?.data??{},this.name="GraphQLError"}}function s(t){if(t.errors?.length)throw new i(t.errors[0])}const r={tembraBase:"https://api.tembra.app"};class n{config;apiUrl;constructor(t,e){this.config=t,this.apiUrl=e}async ping(e){const i=await a(this.apiUrl,{query:t`
			...
			`},{"x-wnt-space-id":this.config.spaceId});return s(e),e.data?.get??null}}const l=`${r.tembraBase}/public/cms/graphql/article`;class p extends n{config;constructor(t){super(t,l),this.config=t}async listTags(e){const i=await a(this.apiUrl,{query:t`
				query {
					listTags {
						id
						name
			...
			`,variables:{data:e,publishedFrom:e.publishedFrom.toISOString(),publishedTo:e.publishedTo?.toISOString()??null}},{"x-wnt-space-id":this.config.spaceId,"x-wnt-api-key":this.config.apiKey??""},i);return s(r),r.data?.importArticleVersion??""}}class m extends n{config;constructor(t){super(t,l),this.config=t}async createComment(e,i){const r=await a(this.apiUrl,{query:t`
			...
			`,variables:{data:e}},{"x-wnt-space-id":this.config.spaceId},i);return s(r),r.data?.listComments}}const g=`${r.tembraBase}/public/cms/graphql/page`;function h(t){return{...t,createdAt:new Date(t.createdAt),updatedAt:new Date(t.updatedAt),publishedFrom:new Date(t.publishedFrom),publishedTo:t.publishedTo?new Date(t.publishedTo):null}}class y extends n{config;constructor(t){super(t,g),this.config=t}async importPage(e,i){const r=await a(this.apiUrl,{query:t`
			...
			`,variables:{data:e}},{"x-wnt-space-id":this.config.spaceId},i);s(r);const n=r.data?.listPageVersions;return n.map(h)}}const b=`${r.tembraBase}/public/cms/graphql/text`;class A extends n{config;constructor(t){super(t,b),this.config=t}async importCategory(e,i){const r=await a(this.apiUrl,{query:t`
			...
			`,variables:{data:e,ver:i}},{"x-wnt-space-id":this.config.spaceId},r);s(n);const d=n.data?.listKeyValues;return d.map(t=>({...w(t),versions:t.versions.map(w),fullVersions:t.fullVersions?.map(w)??void 0}))}}export{c as ArticleApi,m as CommentApi,f as KeyValueApi,y as PageApi,o as SpaceApi,p as TagApi,A as TextApi,r as apiConfig};
//# sourceMappingURL=tembra-api.1.0.2.mjs.map
